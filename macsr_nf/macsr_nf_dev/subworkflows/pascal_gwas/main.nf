...
// 23 01 2025 network processing split from here to
//  subworkflows/network_processing/main.nf
...
// For pre-processing of network module files refer to subworkflows/network_processing/main.nf
