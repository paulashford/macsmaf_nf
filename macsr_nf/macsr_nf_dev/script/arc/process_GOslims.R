...
REFER: git/macsmaf/macsr_nf/macsr_nf_dev/script/go_slim.r


# updated 09 01 2025 from:
# experiments/e019/process_GOslims.R
# amended for K1 x 3 dbs
# NOTE this is just to get the top 25% (or whatever cut-off) of enriched GO terms per module which
# are *then* used for GO-slim processing (ie this is a pre-processing script, really)
